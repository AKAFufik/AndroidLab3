    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View.OnClickListener oclBtn1 = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (cursor.moveToFirst()) {
                    ...
                    int nameIndex = cursor.getColumnIndex(DataBaseHelper.FIO);
                    int dateIndex = cursor.getColumnIndex(DataBaseHelper.dateOfAdd);
                    do {
                        BD.add("ID:" + cursor.getInt(idIndex)+" ФИО:" + cursor.getString(nameIndex) +" время:"+ cursor.getString(dateIndex));
        ...
        View.OnClickListener oclBtn2 = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                contentValues.put(DataBaseHelper.FIO, (strArray1[num1] + strArray2[num2] + strArray3[num3]));
        ...
        View.OnClickListener oclBtn3 = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                cv.put(DataBaseHelper.FIO, "Иванов Иван Иванович");
